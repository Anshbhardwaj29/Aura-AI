    ...
    <header className=" top-0 z-50 w-full duration-300 pt-2 pb-2 relative">
      <div className="container mx-auto flex h-14 items-center justify-between px-4 sm:px-8">
        ...
        <div className="flex items-center gap-5 z-10 justify-end w-40">
          <Link to="/login" className="hidden sm:inline-block text-sm font-medium text-foreground hover:text-aura-primary transition-colors">
            Login
          </Link>
          <Button className="rounded-full px-5 h-9 font-semibold hidden sm:inline-flex shadow-[0_0_15px_rgba(139,92,246,0.3)]">
            Get Started
          </Button>
